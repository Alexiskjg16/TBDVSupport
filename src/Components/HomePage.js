    ...
    render() {
        return (
            <div className="AboutHome">
                ...
                <h1> Welcome to SupportResource, a webpage dedicated to helping those effected by domestic violence.
                    On these pages you can click "I Feel Empowered" to share your successes and victories in your journey,
                    or on "I Need Support" you can let us know your story or a struggle you are having. These posts are public,
                    so be cautious with specific details, but take comfort in reading others' stories and knowing that you are NOT alone. </h1>
                <p> About the creator: I was in a domestic violence relationship for seven years, married for nearly five. In addition
